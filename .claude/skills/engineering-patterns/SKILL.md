...
description: >-
  Classic engineering patterns applied to SvelteKit + TypeScript + Supabase projects.
  Use when structuring a SvelteKit app, organizing data access, abstracting third-party
  services, managing shared state, improving testability, or when the user describes a
  problem that a Factory, Repository, Service Layer, Singleton, Strategy, Observer, or
  Adapter pattern would solve.
---
